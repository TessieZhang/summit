        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="portfolio-item">
                    <div class="portfolio-image">
                        <a href="#"><img src="img/kitchenhand.jpg" alt="Project Name"></a>
                    </div>
                </div>
            </div>
            <!-- End Image Column -->
            ...
            <div class="portfolio-item-description col-sm-6">
                ...
                <ul class="no-list-style">
                    ...
                    <button type="button" class="btn btn-default btn-lg" id="myBtn1-kitchen-hand">Wage</button>
                            ...
                            <div id="collapse11" class="accordion-body collapse in">
                                <div class="accordion-inner">
                                    ...
                                    <ul>
                                        ...
                                        <li>Where possible, use alternative cooking methods to deep frying (eg microwaving, grilling or baking).</li>
                                        <li>Post signs to warn workers about hot equipment and use stickers for stainless steel utensils.</li>
                                        <li>Keep pot handles away from the stove’s edge.</li>
                                        <li>Design the workplace or work processes to avoid carrying around hot liquids.</li>
                                    </ul>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse12" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    ...
                                    <ul>
                                        <li>Store chemicals in approved containers, do not use old drink or food containers.</li>
                                        <li>Do a risk assessment for all hazardous substances to determine how to use the chemicals safely.</li>
                                        <li>Post emergency numbers, including poison information numbers, beside the telephone.</li>
                                        <li>Make the MSDS and risk assessments available to people who use the chemicals at all times so they can refer to them.</li>
                                    </ul>
                                    <div class="answer">The Most Common Injuries:</div>
                                    <ul>
                            ...
                            <div id="collapse13" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    ...
                                    <ul>
                                        ...
                                        <li>Ensure slicing machines and butchers’ steels for knife sharpening have hand guards.</li>
                                        <li>Provide the correct knife for the task and only use knives for cutting purposes.</li>
                                        <li>Provide mesh gloves and use them when working with knives.</li>
                                        <li>Train and instruct workers to use and sharpen knives safely. Provide workers with training first aid.</li>
                                    </ul>
                                    <div class="answer">The Most Common Injuries:</div>
                                    <ul>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse21" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    ...
                                    <ul>
                                        <li>Put gas equipment in a well-lit and draught-free area and install a gas shutoff valve so the supply can be stopped if necessary.</li>
                                        <li>Install, use and maintain electrical appliances properly.</li>
                                        <li>Inspect and maintain gas equipment and the fuel supply system regularly. The switch for the gas supply should be accessible and clearly labelled.</li>
                                        <li>Fire safety installations (sprinkler systems and  re alarms) should be regularly maintained by quali ed personnel.</li>
                                        <li>Emergency plans should include a procedure to provide prompt treatment for burns and smoke inhalation.</li>
                                    </ul>
                                    <div class="answer">The Most Common Injuries:</div>
                                    <ul>
                                        <li><a href="<?php echo site_url('Welcome/newPage/burn'); ?>">Burns</a></li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse22" class="accordion-body collapse">
                                <div class="accordion-inner">
                                    ...
                                    <ul>
                                        <li>Remove faulty electrical equipment immediately from service and attach a warning label to it.</li>
                                        <li>Install safety switches to guard against electric shock.</li>
                                        <li>Always hire a licensed electrical contractor to install or repair electrical equipment. It’s dangerous, illegal and could be fatal to attempt this work yourself.</li>
                                        <li>Provide enough power points for each work area. Only use power boards  tted with overload protection. The use of extension leads or double adaptors is not recommended.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="portfolio-item">
                    ...
                    <div class="portfolio-info-fade">
                        <ul>
                            ...
                            <li class="read-more"><a href="http://localhost/project1/cut.php" class="btn">Read more</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="portfolio-item">
                    ...
                    <div class="portfolio-info-fade">
                        <ul>
                            ...
                            <li class="read-more"><a href="http://localhost/project1/burn.php" class="btn">Read more</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="portfolio-item">
                    ...
                    <div class="portfolio-info-fade">
                        <ul>
                            ...
                            <li class="read-more"><a href="http://localhost/project1/fall.php" class="btn">Read more</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="quiz" id="quiz1" data-toggle="buttons">
                        ...
                        <label class="element-animation1 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="1">1 Avoiding slip / trip prone areas completely </label>
                        <label class="element-animation2 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="2">2 Wearing appropriate safety boots </label>
...
<div class="modal fade" id="myModal2" role="dialog">
                ...
                <div id="Q1">
                    ...
                    <div class="quiz" id="quiz2" data-toggle="buttons">
                        ...
                        <label class="element-animation1 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="1">1 Cleaning and organizing passageways, service rooms, storerooms and places of employment
                        </label>
                        <label class="element-animation2 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="2">2 Keeping equipment on stairways where they can be easily located
                            yourself </label>
                        ...
                        <label class="element-animation3 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="3">3
                            Maintaining drainage, false floors, mats, platforms or dry standing places where there are wet or oily processes</label>
                        <label class="element-animation4 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="4">4
    ...
    <span id="answer2I" style="float: left; text-align:justify;"><b>Incorrect!</b> Explanation: All areas in the workplace must be kept clean and orderly. Furthermore, “The floor of every workroom shall be maintained in a clean and, so far as possible, a dry condition. Where wet processes are used, drainage shall be maintained and false floors, platforms, mats, or other dry standing places should be provided where practicable.	</span>
                        <span id="answer2C" style="float: left; text-align:justify;"><b>Correct!</b> Explanation: All areas in the workplace must be kept clean and orderly. Furthermore, “The floor of every workroom shall be maintained in a clean and, so far as possible, a dry condition. Where wet processes are used, drainage shall be maintained and false floors, platforms, mats, or other dry standing places should be provided where practicable.	</span>
...
<div class="modal fade" id="myModal3" role="dialog">
    ...
    <span id="answer3I" style="float: left; text-align:justify;"><b>Incorrect!</b> Explanation: Should you fall, you must:
 ...
 <li>Falling correctly requires adequate training.</li></ul></span>
                        <span id="answer3C" style="float: left; text-align:justify;"><b>Correct!</b> Explanation: Should you fall, you must:
 <ul><li>Tuck in your chin and turn your head.</li><li>Twist or roll your body to the side.
</li><li>Keep wrists, knees, and elbows bent.</li><li>Protect your head with your arm.</li>
     <li>Land on as much of your body as possible, to distribute the weight of the fall.</li>
 <li>Never try to break or soften the fall with your hands</li>
...
<div class="modal fade" id="myModal4" role="dialog">
    ...
    <span id="answer4I" style="float: left; text-align:justify;"><b>Incorrect!</b> Explanation: According to Worksafe Victoria, “employers are not required to provide portable fire extinguishers in the office. But if they do, they must set up an educational program to acquaint employees with the general principles of fire extinguisher use”.
		</span>
                        <span id="answer4C" style="float: left; text-align:justify;"><b>Correct!</b> Explanation: According to Worksafe Victoria, “employers are not required to provide portable fire extinguishers in the office. But if they do, they must set up an educational program to acquaint employees with the general principles of fire extinguisher use”.
		</span>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h3 style="line-height: 150%; text-align:justify;"><span class="label label-warning" id="qid">5</span>
                    Below is a list of fire extinguisher types matched with surfaces on which they can be used. Which is the <b>incorrect</b> option?</h3>
            </div>
            <div class="modal-body">
                <div id="Q1">
                    <div class="col-xs-3 col-xs-offset-5">
                    ...
                    <div class="quiz" id="quiz5" data-toggle="buttons">
                        ...
                        <label class="element-animation1 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="1">1 Class A - Cloth, wood, paper, and rubber
                        </label>
                        <label class="element-animation2 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="2">2 Class B - Plastics, oils, grease, gasoline, solvents, and other flammable liquids
                        </label>

                        <label class="element-animation3 btn btn-lg btn-primary btn-block"><span class="btn-label"><i
                                    class="glyphicon glyphicon-chevron-right"></i></span> <input type="radio"
                                                                                                 name="q_answer"
                                                                                                 value="3">3 Class C - Wiring, fuse boxes, electrical equipment, and computers</label>
            ...
            <div class="modal-footer text-muted ">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <span id="answer5I" style="float: left; text-align:justify;"><b>Incorrect!</b> Explanation: Class B fire extinguishers use carbon dioxide as the fire-fighting agent and can extinguish oils, paints, lacquers, grease, solvents, and flammable liquids. Fires on plastic surfaces can be put out via a Class A fire extinguisher, which uses water.
</span>
                        <span id="answer5C" style="float: left; text-align:justify;"><b>Correct!</b> Explanation: Class B fire extinguishers use carbon dioxide as the fire-fighting agent and can extinguish oils, paints, lacquers, grease, solvents, and flammable liquids. Fires on plastic surfaces can be put out via a Class A fire extinguisher, which uses water.
</span>
