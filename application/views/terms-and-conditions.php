...
<?php $this->load->view('header'); ?>      
        ...
        <div class="section">
	        <div class="container">
	        <h2>Welcome to safe@PTJ!</h2>
            <p>These terms and conditions outline the rules and regulations for the use of  safe@PTJ's Website. <br />
                <span style="text-transform: capitalize;">safe@PTJ</span> is located at:<br />
                <address>
                    900 dandenong road, Caulfield east , <br />
                    Melbourne, VIC 3145<br />
                    Australia<br />
                </address>
                By accessing this website we assume you accept these terms and conditions in full. Do not continue to use safe@PTJ's website if you do not accept all of the terms and conditions stated on this page.
            </p>
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or all Agreements: "Client", ìYouî and ìYourî refers to you, the person accessing this website and accepting the Companyís terms and conditions. "The Company", ìOurselvesî, ìWeî, ìOurî and "Us", refers to our Company. ìPartyî, ìPartiesî, or ìUsî, refers to both the Client and ourselves, or either the Client or ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner, whether by formal meetings of a fixed duration, or any other means, for the express purpose of meeting the Clientís needs in respect of provision of the Companyís stated services/products, in accordance with and subject to, prevailing law of Australia. Any use of the above terminology or other words in the singular, plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>

            <h2>Cookies</h2>
            <p>We employ the use of cookies. By using <a href="http://safeatpart-timejob.tk/" onclick="__gaTracker('send', 'event', 'outbound-article', 'http://safeatpart-timejob.tk/', 'safe@PTJ');" title="safe@PTJ">safe@PTJ</a>'s website you consent to the use of cookies in accordance with safe@PTJís privacy policy.</p>
            ...
            <h2>License</h2>
            <p>Unless otherwise stated, safe@PTJ and/or itís licensors own the intellectual property rights for all material on safe@PTJ All intellectual property rights are reserved. You may view and/or print pages from http://safeatpart-timejob.tk/ for your own personal use subject to restrictions set in these terms and conditions.</p>
            <p>You must not:</p>
            <ul>
                <li>Republish material from http://safeatpart-timejob.tk/</li>
                <li>Sell, rent or sub-license material from http://safeatpart-timejob.tk/</li>
                <li>Reproduce, duplicate or copy material from http://safeatpart-timejob.tk/</li>
            </ul>
            <p>Redistribute content from safe@PTJ (unless content is specifically made for redistribution).</p>

            <h3>User Comments</h3>
            <ol>
                <li>This Agreement shall begin on the date hereof.</li>
                <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. safe@PTJ does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of safe@PTJ, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws safe@PTJ shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
                <li>safe@PTJ reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
                ...
                <li>You hereby grant to <strong>safe@PTJ</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
            </ol>
            ...
            <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="mailto:ylin195@student.monash.edu" title="send an email to ylin195@student.monash.edu">ylin195@student.monash.edu</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
            ...
            <p>No use of (cname)ís logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
